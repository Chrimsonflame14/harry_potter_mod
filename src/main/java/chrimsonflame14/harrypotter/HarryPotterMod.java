...
public class HarryPotterMod {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		itemChalk = new ItemChalk().setUnlocalizedName("ItemChalk");
		GameRegistry.registerItem(itemChalk, itemChalk.getUnlocalizedName().substring(5));
		
		itemSrobe = new ItemSrobe().setUnlocalizedName("ItemSlytherin Robe");
		GameRegistry.registerItem(itemSrobe, itemSrobe.getUnlocalizedName().substring(5));
		
		itemRrobe = new ItemRrobe().setUnlocalizedName("ItemRavenclaw Robe");
		GameRegistry.registerItem(itemRrobe, itemRrobe.getUnlocalizedName().substring(5));
		
		itemHrobe = new ItemHrobe().setUnlocalizedName("ItemHufflepuff Robe");
		GameRegistry.registerItem(itemHrobe, itemHrobe.getUnlocalizedName().substring(5));
		
		itemGrobe = new ItemGrobe().setUnlocalizedName("ItemGryffindor Robe");
		GameRegistry.registerItem(itemGrobe, itemGrobe.getUnlocalizedName().substring(5));
